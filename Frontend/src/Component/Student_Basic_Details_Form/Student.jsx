...
const recentWinners = [
  {
    ...
    amount: "$5,000",
    quote: "Edu-Empower changed my life by connecting me with scholarships I never knew existed.",
    university: "MIT",
  ...
  },
  {
    ...
    amount: "$2,500",
    quote: "The platform made it so easy to find and apply for scholarships tailored to my interests.",
    university: "Stanford",
  ...
  },
  {
    ...
    amount: "$3,750",
    quote: "I was able to fund my entire semester thanks to the opportunities I found here.",
    university: "Columbia",
...
export default function ScholarshipHero() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white to-gray-50 overflow-hidden">
      ...
      <div ref={heroRef} className="scholarship-hero-wrapper flex-grow relative">
            ...
            >
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-gray-500">No essay required</span>
                </div>
                <div className="flex items-center">
                  <svg className="w-5 h-5 text-green-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                ...
                <div className="relative h-64">
                  ...
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <h3 className="text-2xl font-bold mt-1">
                      <CountUp start={33900000} end={33911846} duration={15} prefix="$" />
                    </h3>
                    ...
                    {recentWinners.map((winner, idx) => (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600">Won <span className="font-semibold text-indigo-600">{winner.amount}</span> • {winner.scholarship}</p>
                          <div className="mt-2 bg-gray-50 p-2 rounded-lg">
                            <p className="text-sm italic text-gray-700">"{winner.quote}"</p>
                          </div>
                        </div>
                      </motion.div>
                    ))}
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div className="ml-3 flex-1">
                          <p className="text-sm font-medium">{notification.name} won <span className="text-green-600">{notification.amount}</span></p>
        ...
        >
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900">How Edu-Empower Works</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Apply & Win</h3>
                  <p className="text-gray-600">Apply directly through our platform with simplified applications and track your status.</p>
                </div>
              </motion.div>
            </div>
          </div>
