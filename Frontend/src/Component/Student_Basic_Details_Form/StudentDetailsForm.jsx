...
>>>>>>> ae6116019cd7abd8e1e4dd063e4ebbc666da2a86
  ...
  // Update the API_BASE_URL to ensure consistency
  // Remove this duplicate declaration - you already have it at the top of the file
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                ...
                <div>
                  ...
                  <textarea
                    name="careerGoals" // Changed from aboutSelf to careerGoals
                    value={formData.careerGoals} // Changed from aboutSelf to careerGoals
                    onChange={handleChange}
                    rows="4"
                    className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
