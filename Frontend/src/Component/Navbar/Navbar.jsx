    ...
    <Disclosure as="nav" className="bg-white shadow-md fixed w-full z-10">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-22 items-center justify-between">
          ...
          {/* Register Buttons with Clerk SignUp */}
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0 space-x-4">
            <SignUpButton mode="modal">
              <button
                type="button"
                className="bg-black text-white shadow-md rounded-md px-4 py-2 text-sm font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2"
              >
                Register as Student
              </button>
            </SignUpButton>
