...
const Hero = () => {
  ...
  return (
    <div
      ref={heroRef}
      className="relative min-h-screen h-auto flex items-center pt-10 pb-24 overflow-hidden"
    >
            ...
            <div className="relative">
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  Access to 500+ scholarships tailored to your profile
                </p>
              ...
              >
                ...
                <p className="text-sm text-gray-600">
                  Join a supportive network of students and donors
                </p>
                <div className="mt-2">
              ...
              >
                ...
                <p className="text-sm text-white/90">
                  Raise funds for your education goals
                </p>
                <motion.button
